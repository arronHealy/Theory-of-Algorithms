...
const uint32_t K[] = {
  ...
  0xa2bfe8a1, 0xa81a664b, 0xc24b8b70, 0xc24b8b70, 
...
// Majority - Section 4.1.2
uint32_t Maj(uint32_t x, uint32_t y, uint32_t z);

// Shift Right - Section 3.2
uint32_t SHR(uint32_t x, int n);

// Rotate Right - Section 3.2
uint32_t ROTR(uint32_t x, int n);

// Sigma 0 - Section 4.1.2
uint32_t Sig0(uint32_t x);

// Sigma 1 - Section 4.1.2
uint32_t Sig1(uint32_t x);

// Sigma 2 - Section 4.1.2
uint32_t sig0(uint32_t x);
